...
function MobileMenu() {
  ...
  const DrawerList = (
    <Box
      sx={{
        width: 250,
        bgcolor: theme === "dark" ? "#002047" : "white",
      ...
      <nav className="mt-4 flex-1">
        ...
        <Link
          ...
          className={`flex items-center gap-4 py-2 px-4 hover:bg-hover-effect transition-all duration-300 ${
            pathname.includes("/dashboard") ? "border-l-4 border-blue-500" : ""
          }`}
        >
          <svg
            width="20"
        ...
        <Link
          href="/orders"
          className={`flex items-center gap-4 py-2 px-4 hover:bg-hover-effect transition-all duration-300 ${
            pathname.includes("/orders") ? "border-l-4 border-blue-500" : ""
          }`}
        >
          <svg
            width="20"
        ...
        <Link
          href="/documents"
          className={`flex items-center gap-4 py-2 px-4 hover:bg-hover-effect transition-all duration-300 ${
            pathname.includes("/documents") ? "border-l-4 border-blue-500" : ""
          }`}
        >
          <svg
            width="20"
        ...
        <Link
          href="/settings"
          className={`flex items-center gap-4 py-2 px-4 hover:bg-hover-effect transition-all duration-300 ${
            pathname.includes("/settings") ? "border-l-4 border-blue-500" : ""
          }`}
        >
          <svg
            width="20"
  ...
  return (
    <div>
      <motion.button
        whileTap={{ scale: 0.85 }}
        className="p-2 rounded-full bg-secondary min-[965px]:hidden"
      ...
      <Drawer
        ...
        PaperProps={{
          sx: {
            bgcolor: currentTheme === "dark" ? "rgb(24 24 27)" : "white",
          },
        }}
      >
        {DrawerList}
